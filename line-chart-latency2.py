...
l1, = axs[0].plot(x, y3,  linewidth=1.5, color="black",marker="o", markersize=4.5)
...
l4, = axs[1].plot(x, y3,  linewidth=1.5, color="black",marker="o", markersize=4.5)
...
l6, = axs[2].plot(x, y3,  linewidth=1.5, color="black",marker="o", markersize=4.5)
...
l6, = axs[3].plot(x, y3,  linewidth=1.5, color="black",marker="o", markersize=4.5)
...
l6, = axs[4].plot(x, y3,  linewidth=1.5, color="black",marker="o", markersize=4.5)
...
axs[0].set_title("(a) Apache (RPS)")
axs[1].set_title("(b) OLTP RO (EPS)")
axs[2].set_title("(c) OLTP RW (EPS)")
axs[3].set_title("(d) Redis G. (RPS)")
axs[4].set_title("(e) R. G./S. (RPS)")
