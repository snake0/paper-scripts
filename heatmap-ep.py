...
R1 = np.loadtxt("/Users/snake0/taco-journal/newdata/ep.C.csv",delimiter=",",skiprows=1)
# R1=R1+1
# R1 = np.log2(R1)
...
plt.title('EP.D (47MiB)',fontdict=font)

plt.tight_layout()
plt.subplots_adjust(left=0.08,right=0.97,bottom=0.04,top=0.97)

plt.savefig('/Users/snake0/taco-journal/newimgs/ep.C.pdf', dpi=100)
plt.show()
