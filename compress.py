...
ax1.legend(loc=2, frameon=False, prop={'size': 13}, ncol=2)
...
ax1.set_ylabel("(De)compression Latency\nper Page (μs)")
...
plt.savefig('/Users/snake0/yanni-img/compress.pdf', dpi=300, bbox_inches='tight')
plt.show()
