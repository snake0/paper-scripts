...
plt.plot(y_rdma_sort3, y_rdma_cdf3,label="WRITE",linewidth=1.4,color=colors[3],linestyle="dotted")
plt.plot(y_tcp_sort3, y_tcp_cdf3,label="READ",linewidth=1.8, color="black")
plt.plot(y_iboip_sort3, y_iboip_cdf3,label="WRITE-XBZRLE",linewidth=2.2, color=colors[0])
...
plt.xlabel("Critical-path Function Latency (ns)")
plt.xscale("log")
plt.ylim([0,1])
plt.ylabel("CDF")
# plt.xlim([2400,184500])
...
fig.tight_layout()
fig.savefig('/Users/snake0/MasterThesis/figures/cdf.pdf', dpi=300, bbox_inches='tight')
plt.show()
