...
axs[0].set_ylabel('OLTP RO Latency (P95)')
...
axs[1].legend((t1, t2, t3, t4), ("MIN", "AVG", "P95", "MAX"),
              loc='upper left', frameon=False, facecolor="white", ncol=2)
...
axs[0].set_title("(a) Eviction Policy")
axs[1].set_title("(b) PML ($=512M)")
axs[2].set_title("(c) Associativity ($=512M)")
